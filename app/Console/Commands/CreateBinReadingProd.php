...
class CreateBinReadingProd extends Command
{
    protected $signature = 'bin:reading-prod {bio} {nonbio}';
    protected $description = 'Send a bin reading to the production website. 1st arg = Bio fill level, 2nd arg = Non-Bio fill level OR B/N label.';
    ...
    public function handle()
    {
        ...
        elseif (is_numeric($first) && in_array($second, ['B', 'N'])) {
            ...
            $this->error('Invalid arguments. Usage: bin:reading-prod 90 45 OR bin:reading-prod 90 B');
            return 1;
        }
