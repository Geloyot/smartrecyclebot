...
// ========================
const char* mqtt_server = "5ab0d2c4f77a43eca19fb7862d8a012c.s1.eu.hivemq.cloud";  // Replace with your cluster URL
const int mqtt_port = 8883;                                    // Secure MQTT port
const char* mqtt_username = "smartrecyclebot";                 // Your HiveMQ username
const char* mqtt_password = "Smartrecyclebot-hivemqttbroker1";              // Your HiveMQ password
